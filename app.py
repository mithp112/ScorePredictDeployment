    ...
    if request.method == "POST":
        try:
            ...
            with ThreadPoolExecutor() as executor:
                ...
                pred_df1 = pred_df1.applymap(lambda x: min(round(x, 1), 10))
                pred_df2 = pred_df2.applymap(lambda x: min(round(x, 1), 10))
                pred_df3 = pred_df3.applymap(lambda x: min(round(x, 1), 10))
        ...
        try:
            ...
            with ThreadPoolExecutor() as executor:
                if nature_checked:
                    ...
                    subjects = {'mon1': 'Điểm Lý', 'mon2': 'Điểm Hóa', 'mon3': 'Điểm Sinh'}
                else:
                    print("call XH")
                    ...
                    subjects = {'mon1': 'Điểm Sử', 'mon2': 'Điểm Địa', 'mon3': 'Điểm GDCD'}
